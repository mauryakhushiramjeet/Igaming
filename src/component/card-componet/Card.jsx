                        ...
                        <div key={index} className="mt-[40px]  ">
                            ...
                            <div  className="sm:w-[391px]  max-xs-375:w-[330px] max-sm-425:w-[300px] z-[1] max-xxs-320:w-[270px]
                             bg-[#19222B] flex flex-col justify-center items-center rounded-[15px] mx-4  md:mx-[52px] relative ">
                                ...
                                <div className="w-[170px] h-[150px] max-sm-425:w-[150px] max-sm-425:h-[150px] z-0 absolute rounded-full top-[70px]  bg-[#42FA7E24] blur-[20px] "></div>
                                <div  className="sm:w-[327px] max-sm-425:w-[230px] z-[1] max-xxs-320:w-[200px] sm:h-[98px] xs-375:h-[80px] max-sm-425:h-[70px] border-[1px] border-[#42F67838] bg-[#0D1218] items-center flex justify-center sm:mt-[32px] mt-[25px] rounded-[8px]">
